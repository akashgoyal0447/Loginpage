...
public class LoginActivity extends AppCompatActivity implements MyCallBackInterface{
        ...
        mLogBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUsername.getText().toString().isEmpty()) {
                    ...
                    new LoginAsyncTask(LoginActivity.this,LoginActivity.this).execute("http://172.26.49.179:8080/ree.json");
                }
            }
        });
    }
    ...
    public void dataReceived(String str) {
        try {
            ...
            JSONArray arrayOfUsers = object.getJSONArray("login");
            for (int i = 0; i < arrayOfUsers.length(); i++) {
                JSONObject arrayObject = arrayOfUsers.getJSONObject(i);
                String user = arrayObject.optString("username");
                String pass = arrayObject.optString("password");
                if (user.equals(mUsername.getText().toString()) && pass.equals(mPassword.getText().toString())) {
                    check = 1;
                    break;
                }
